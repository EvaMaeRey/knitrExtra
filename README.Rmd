...
```
And we can't access chunk names from within a live .Rmd, or the code from chunks in the document we are working on.  But this kind of 'self-awareness' can be really useful
  
With the {knitrExtra} package, we'll live in a different world (🦄 🦄 🦄) where the task is a snap 🫰: 
